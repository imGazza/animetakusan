...
public class RabbitMqConsumerService : BackgroundService
{
    ...
    public RabbitMqConsumerService(IOptions<MalSyncActionOptions> options, IRabbitMqConnectionManager connectionManager, IServiceScopeFactory serviceScopeFactory, ILogger<RabbitMqConsumerService> logger)
    {
