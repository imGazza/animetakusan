...
namespace AnimeTakusan.Infrastructure.DataPersistence.Migrations
{
    ...
    [Migration("20260630191354_User_RemovedUselessInfo")]
    partial class User_RemovedUselessInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimeTakusan.Domain.Entities.AniListUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("AniListAvatar")
                        .HasColumnType("text");

                    b.Property<int>("AniListUserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AnimeTakusan.Domain.Entities.AniListUser", b =>
                {
                    b.HasOne("AnimeTakusan.Domain.Entities.User", "User")
                        .WithOne("AniListUser")
                        .HasForeignKey("AnimeTakusan.Domain.Entities.AniListUser", "UserId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("AnimeTakusan.Domain.Entities.User", null)
                        .WithMany()
