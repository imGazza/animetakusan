...
export const animeApis = {
  ...
  deleteAnimeEntry: ({ mediaListEntryId, malId }: { mediaListEntryId: number; malId: number }): Promise<EntryDeleted> => httpClient.post(`/anime/delete-entry`, { mediaListEntryId, malId }),
