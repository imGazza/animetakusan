    ...
    <div>
      <div className="relative w-full h-[200px] md:h-[400px]">
        ...
        <Container className="h-full relative flex items-end p-4 py-4 px-6 gap-4">
          <div className="w-28 shrink-0 rounded-xs overflow-hidden">
          ...
          <div className="flex flex-col gap-2 w-full">
            <div className="flex flex-col gap-0.5">
              <h1 className="text-primary font-semibold text-xl leading-tight line-clamp-2">
                {anime.title.english || anime.title.romaji || ""}
              </h1>
              <div className="text-sm text-primary/70 line-clamp-1">
                {anime.title.native || ""}
              </div>
            </div>
